# coding: utf-8
from app import app
# The database connections and session management are managed with SQLAlchemy f$
...
# The Geometry columns of the data tables are added to the ORM using the Geomet$
...
class TbDbagebscdmx(Base):
    __tablename__ = 'tb_dbagebscdmx'

    gid = Column(Integer, primary_key=True, server_default=text("nextval('tb_dbagebscdmx_gid_seq'::regclass)"))
